manywho.draw.ajax = (function () {
    ...
    return {
        ...
        getFlowGraph: function (flowId)  {
            ...
            $.ajax({
                url: manywho.platform.uri + '/api/draw/1/graph/flow/' + flowId,
                type: 'GET',
                dataType: 'json',
        ...
        updateFlowGraph: function (model) {
            ...
            $.ajax({
                url: manywho.platform.uri + '/api/draw/1/graph/flow',
                type: 'POST',
                dataType: 'json',
                contentType: 'application/json',
                processData: true,
        ...
        getFlowByName: function (flowName, tenantId) {
            ...
            return $.ajax({
                url: manywho.platform.uri + '/api/run/1/flow/name/' + flowName,
                type: 'GET',
                dataType: 'json',
                contentType: 'application/json',
                beforeSend: function (xhr) {
        ...
        initialize: function (engineInitializationRequest, tenantId, authenticationToken) {
            ...
            return $.ajax({
                url: manywho.platform.uri + '/api/run/1',
                type: 'POST',
                dataType: 'json',
                contentType: 'application/json',
                processData: true,
